...
<div>
    ...
    <b-card class="col-12 p-2">
        <b-tabs content-class="pt-1" fill v-if="data != null" >
            <b-tab>
                <template #title>
            ...
            <b-tab>
                ...
                <div>
                    <div v-if="panelHistorico != 3">
                        <div v-if="panelHistorico == 2" class="col-12 d-flex align-items-center mb-2">
                            <div>
                                <b-button
                                size="sm"
                                variant="outline-danger"
...
<script>
import { BTabs, BTab, BCard, BButton, BAvatar } from 'bootstrap-vue'
...
export default {
    ...
    methods:{
        atrasDetalleMes(){
            ...
            setTimeout(() => { this.panelHistorico = tmp }, 5);
        },
