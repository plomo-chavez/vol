...
/* harmony import */ var _views_voluntarios_formVoluntario_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/views/voluntarios/formVoluntario.vue */ "./resources/js/src/views/voluntarios/formVoluntario.vue");
/* harmony import */ var _views_voluntarios_detallesVoluntario_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/views/voluntarios/detallesVoluntario.vue */ "./resources/js/src/views/voluntarios/detallesVoluntario.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    detallesVoluntario: _views_voluntarios_detallesVoluntario_vue__WEBPACK_IMPORTED_MODULE_7__["default"],
    formVoluntario: _views_voluntarios_formVoluntario_vue__WEBPACK_IMPORTED_MODULE_6__["default"]
  },
  data: function data() {
    return {
      accion: 1,
      ...
      configTable: {
        ...
        btnFiltrar: true,
        btnOtros: [{
          label: 'Generar ficha de registro',
  ...
  methods: {
    ...
    reload: function reload() {
      _apis_usePeticiones__WEBPACK_IMPORTED_MODULE_4__["default"].getVoluntarios({}).then(function (response) {
    ...
    peticionAdministrar: function peticionAdministrar(payload) {
      var _this2 = this;
      this.loading();
      _apis_usePeticiones__WEBPACK_IMPORTED_MODULE_4__["default"].administrarVoluntarios({
        'payload': payload
