...
/* harmony import */ var _detallesDelegacion_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./detallesDelegacion.vue */ "./resources/js/src/views/delegaciones/detallesDelegacion.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    detallesDelegacion: _detallesDelegacion_vue__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
  data: function data() {
    return {
      config: {
  ...
  methods: {
    ...
    reload: function reload() {
      var _this = this;
      _apis_usePeticiones__WEBPACK_IMPORTED_MODULE_6__["default"].getDelegaciones({}).then(function (response) {
    ...
    peticionAdministrar: function peticionAdministrar(payload) {
      var _this2 = this;
      _apis_usePeticiones__WEBPACK_IMPORTED_MODULE_6__["default"].administrarDelegaciones({
        'payload': payload
...
/* harmony import */ var _views_voluntarios_formDatosVoluntario_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/views/voluntarios/formDatosVoluntario.vue */ "./resources/js/src/views/voluntarios/formDatosVoluntario.vue");
/* harmony import */ var _views_voluntarios_tabHorasVoluntarias_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/views/voluntarios/tabHorasVoluntarias.vue */ "./resources/js/src/views/voluntarios/tabHorasVoluntarias.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    formDatosVoluntario: _views_voluntarios_formDatosVoluntario_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
    tabHoras: _views_voluntarios_tabHorasVoluntarias_vue__WEBPACK_IMPORTED_MODULE_4__["default"]
  },
  ...
  beforeMount: function beforeMount() {
    ...
    if (this.voluntario_id != null) {
      this.loading();
      if (this.isRegistro) {
        _apis_usePeticiones__WEBPACK_IMPORTED_MODULE_5__["default"].getVoluntarioOut({
          'payload': {
        ...
        _apis_usePeticiones__WEBPACK_IMPORTED_MODULE_5__["default"].getVoluntario({
          'payload': {
            id: this.voluntario_id
          }
        }).then(function (response) {
          ...
          [
            _vm.accion == 1
              ...
              : _c("detallesDelegacion", {
                  attrs: { activeData: _vm.activeRow, schema: _vm.formSchema },
                }),
          ],
          1
        )
