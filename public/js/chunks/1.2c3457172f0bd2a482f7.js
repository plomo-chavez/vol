...
var apiPeticiones = /*#__PURE__*/function () {
  ...
  Object(_Users_plomo_Documents_MAMP_vol_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_2__["default"])(apiPeticiones, [{
    ...
    value: function getHorasVoluntarias() {
      ...
      return (_this$axiosIns8 = this.axiosIns).post.apply(_this$axiosIns8, [this.apisConfig.apiGetHorasVoluntarias].concat(args));
    }
  }, {
    ...
    value: function administrarHorasVoluntarias() {
      ...
      return (_this$axiosIns9 = this.axiosIns).post.apply(_this$axiosIns9, [this.apisConfig.apiAdminHorasVoluntarias].concat(args));
    }
  }, {
    ...
    value: function getCoordinaciones() {
      ...
      return (_this$axiosIns10 = this.axiosIns).post.apply(_this$axiosIns10, [this.apisConfig.apiGetCoordinaciones].concat(args));
    }
  }, {
    ...
    value: function administrarCoordinaciones() {
      ...
      return (_this$axiosIns11 = this.axiosIns).post.apply(_this$axiosIns11, [this.apisConfig.apiAdminCoordinaciones].concat(args));
    }
  }, {
    key: "validCurp",
    value: function validCurp() {
      ...
      return (_this$axiosIns12 = this.axiosIns).post.apply(_this$axiosIns12, [this.apisConfig.apiValidCURP].concat(args));
    }
  }, {
    key: "getDelegaciones",
    value: function getDelegaciones() {
      ...
      return (_this$axiosIns13 = this.axiosIns).post.apply(_this$axiosIns13, [this.apisConfig.apiGetDelegaciones].concat(args));
    }
  }, {
    ...
    value: function administrarDelegaciones() {
      ...
      return (_this$axiosIns14 = this.axiosIns).post.apply(_this$axiosIns14, [this.apisConfig.apiAdminDelegaciones].concat(args));
    }
  }, {
