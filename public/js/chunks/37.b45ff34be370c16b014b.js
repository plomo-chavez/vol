...
var render = function () {
  ...
  return _c(
    "div",
    [
      _c("b-card", { staticClass: "pp-custom" }, [
        _c(
          "div",
          {
            staticClass:
              "col-12 m-0 p-0  bg-secondary d-flex align-items-center justify-content-between",
          },
          [
            _c(
              "div",
            ...
            _c(
              "div",
              { staticClass: "w-1/4  bg-danger d-flex align-items-center m-1" },
              [
                _c(
                  "b-avatar",
                  { attrs: { variant: "light-primary", rounded: "" } },
