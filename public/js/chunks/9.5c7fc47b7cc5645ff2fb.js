...
/* harmony import */ var _currentComponents_FormFactory_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @currentComponents/FormFactory.vue */ "./resources/js/src/views/currentComponents/FormFactory.vue");
/* harmony import */ var _currentComponents_VistaUno_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @currentComponents/VistaUno.vue */ "./resources/js/src/views/currentComponents/VistaUno.vue");
/* harmony import */ var _apis_usePeticiones__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/apis/usePeticiones */ "./resources/js/src/apis/usePeticiones.js");
/* harmony import */ var _helpers_customHelpers__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @helpers/customHelpers */ "./resources/js/src/helpers/customHelpers.js");
/* harmony import */ var _views_voluntarios_formVoluntario_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @/views/voluntarios/formVoluntario.vue */ "./resources/js/src/views/voluntarios/formVoluntario.vue");
/* harmony import */ var _views_horas_formHoras_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @/views/horas/formHoras.vue */ "./resources/js/src/views/horas/formHoras.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    FormFactory: _currentComponents_FormFactory_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
    VistaUno: _currentComponents_VistaUno_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
    formHoras: _views_horas_formHoras_vue__WEBPACK_IMPORTED_MODULE_10__["default"]
  },
  data: function data() {
    var _cellActions;
    return {
      config: {
        cellActions: (_cellActions = {
          btnEditar: false,
          btnEliminar: false
        }, Object(_Users_plomo_Documents_MAMP_vol_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_1__["default"])(_cellActions, "btnEliminar", false), Object(_Users_plomo_Documents_MAMP_vol_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_1__["default"])(_cellActions, "btnEliminar", false), _cellActions),
        index: true,
        buscador: true,
        btnNuevo: true,
        btnFiltrar: false,
  ...
  mixins: [_helpers_customHelpers__WEBPACK_IMPORTED_MODULE_8__["default"]],
  ...
  methods: {
    ...
    reload: function reload() {
      var _this = this;
      _apis_usePeticiones__WEBPACK_IMPORTED_MODULE_7__["default"].getHorasVoluntarias({}).then(function (response) {
    ...
    peticionAdministrar: function peticionAdministrar(payload) {
      var _this2 = this;
      this.loading();
      _apis_usePeticiones__WEBPACK_IMPORTED_MODULE_7__["default"].administrarVoluntarios({
        'payload': payload
